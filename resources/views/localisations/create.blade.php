        ...
        <div class="col-lg-8 col-xl-7">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="location-icon me-3">
                            <i class="bi bi-geo-alt-fill fs-4" style="color: var(--uts-dark);"></i>
                        </div>
                        <div class="text-center">
                            <h4 class="text-white mb-1 fw-bold">Nouvelle Localisation</h4>
                            <p class="text-white mb-0 opacity-75">Ajouter un nouveau point de localisation</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('localisations.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="etage"
                                    ...
                                    <option value="Sous-sol" {{ old('etage') == 'Sous-sol' ? 'selected' : '' }}>Sous-sol</option>
                                    <option value="Rez-de-chaussée" {{ old('etage') == 'Rez-de-chaussée' ? 'selected' : '' }}>Rez-de-chaussée</option>
                                    <option value="1er étage" {{ old('etage') == '1er étage' ? 'selected' : '' }}>1er étage</option>
                                    <option value="2ème étage" {{ old('etage') == '2ème étage' ? 'selected' : '' }}>2ème étage</option>
                                    <option value="3ème étage" {{ old('etage') == '3ème étage' ? 'selected' : '' }}>3ème étage</option>
                                    <option value="4ème étage" {{ old('etage') == '4ème étage' ? 'selected' : '' }}>4ème étage</option>
                                </select>
                                @error('etage')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select name="type"
                                    ...
                                    <option value="Bibliothèque" {{ old('type') == 'Bibliothèque' ? 'selected' : '' }}>Bibliothèque</option>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="description"
                                          ...
                                          rows="4"
                                          placeholder="Description détaillée de la localisation, équipements disponibles, etc.">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
...
document.getElementById('nom').addEventListener('input', function() {
    ...
    if (nom && !document.getElementById('code').value) {
        const code = 'LOC-' + nom.substring(0, 10).toUpperCase().replace(/\s+/g, '');
