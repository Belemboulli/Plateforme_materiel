...
<div class="categories-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="header-text">
                ...
                <p class="page-subtitle">Organisez et gérez efficacement vos catégories de matériel</p>
            </div>
        </div>
        ...
        <div class="header-actions">
            ...
            <a href="{{ route('categories.create') }}" class="btn-action primary">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card success">
            ...
            <div class="stat-content">
                <h3 class="stat-number">{{ $categories->where('created_at', '>=', now()->subWeek())->count() }}</h3>
        ...
        <div class="stat-card warning">
            ...
            <div class="stat-content">
                <h3 class="stat-number">{{ $categories->where('created_at', '>=', now()->subMonth())->count() }}</h3>
        ...
        <div class="stat-card info">
            ...
            <div class="stat-content">
                <h3 class="stat-number">{{ $categories->sortByDesc('created_at')->first()?->created_at?->diffForHumans() ?? 'N/A' }}</h3>
                <p class="stat-label">Dernière création</p>
            </div>
        </div>
    </div>
    ...
    @if($categories->isEmpty())
        ...
        <div class="empty-state">
            ...
            <h2 class="empty-title">Aucune catégorie disponible</h2>
            <p class="empty-description">
                Commencez par créer votre première catégorie pour organiser efficacement vos matériels.
                Une bonne organisation facilite la gestion de votre inventaire.
            </p>
            <a href="{{ route('categories.create') }}" class="btn-empty-action">
                <i class="fas fa-plus-circle"></i>
                <span>Créer ma première catégorie</span>
            </a>
        </div>
    @else
        <!-- Table moderne des catégories -->
        <div class="data-table-container">
            ...
            <div class="table-header">
                <div class="table-title">
                    ...
                    <div class="results-badge">{{ $categories->count() }} résultat(s)</div>
                </div>
                    ...
                    <table class="modern-table" id="categoriesTable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-description d-none d-md-table-cell">
                                    <i class="fas fa-file-text"></i>
                                    <span>Description</span>
                                </th>
                                <th class="col-date d-none d-lg-table-cell">
                                    <i class="fas fa-calendar"></i>
                                    <span>Création</span>
                                </th>
                        ...
                        <tbody>
                            @foreach ($categories as $categorie)
                                <tr class="table-row category-row" data-id="{{ $categorie->id }}">
                                    <td class="cell-id">
                                        <div class="id-badge">
                                            #{{ str_pad($categorie->id, 3, '0', STR_PAD_LEFT) }}
                                        </div>
                                    </td>
                                    <td class="cell-category">
                                        <div class="category-info">
                                            ...
                                            <div class="category-details">
                                                <h6 class="category-name">{{ $categorie->nom }}</h6>
                                                <span class="category-type">Catégorie</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="cell-description d-none d-md-table-cell">
                                        <div class="description-text">
                                            {{ $categorie->description ? Str::limit($categorie->description, 80) : 'Aucune description disponible' }}
                                        </div>
                                    </td>
                                    <td class="cell-date d-none d-lg-table-cell">
                                        <div class="date-info">
                                    ...
                                    <td class="cell-actions">
                                        <div class="action-buttons">
                                            ...
                                            <button type="button"
                                                    ...
                                                    title="Supprimer"
                                                    onclick="openDeleteModal({{ $categorie->id }}, '{{ addslashes($categorie->nom) }}', '{{ addslashes($categorie->description) }}')">
            ...
            <div class="cards-view" id="cardsView">
                <div class="cards-grid">
                    @foreach ($categories as $categorie)
                        <div class="category-card" data-name="{{ strtolower($categorie->nom) }}">
                            <div class="card-header">
                                <div class="card-icon">
                                    <i class="fas fa-folder"></i>
                                </div>
                                <div class="card-id">#{{ str_pad($categorie->id, 3, '0', STR_PAD_LEFT) }}</div>
                            </div>

                            <div class="card-content">
                                <h5 class="card-title">{{ $categorie->nom }}</h5>
                                <p class="card-description">
                                    {{ $categorie->description ? Str::limit($categorie->description, 100) : 'Aucune description disponible' }}
                                </p>
                                <div class="card-meta">
                            ...
                            <div class="card-actions">
                                <a href="{{ route('categories.show', $categorie->id) }}" class="card-btn primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('categories.edit', $categorie->id) }}" class="card-btn secondary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button type="button"
    ...
    <div class="modal-container">
        ...
        <div class="modal-body">
            ...
            <div class="deletion-preview">
                ...
                <p id="categoryDescriptionPreview"></p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch() {
        ...
        if (resultsBadge) {
            resultsBadge.textContent = `${visibleRows.length} résultat(s)`;
        }
    }
    ...
    window.openDeleteModal = function(id, name, description) {
        const modal = document.getElementById('deleteModal');
        const form = document.getElementById('deleteForm');
        const namePreview = document.getElementById('categoryNamePreview');
        const descriptionPreview = document.getElementById('categoryDescriptionPreview');

        // Mettre à jour le contenu du modal
        if (namePreview) namePreview.textContent = name;
        if (descriptionPreview) {
            descriptionPreview.textContent = description || 'Aucune description disponible';
        }
    ...
    // Amélioration de l'accessibilité avec les tooltips
